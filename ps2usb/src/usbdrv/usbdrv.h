 ...
 */
#define USB_NO_MSG  ((usbMsgLen_t)-1)   /* constant meaning "no message" -1 casted to unsigned char*/
...
extern PROGMEM const
uchar mouse_hid_report[];

extern PROGMEM const
uchar keyboard_hid_report[];
...
#	define PS2_INTR_PENDING_BIT INTF1
#endif
